...
public class MemberService {
	...
	public ArrayList<RecipeDTO> rlist() {

		return dao.rlist();
	}
	
	public ArrayList<ClassesDTO> clist() {
		...
		if (userInfo != null) {
			...
			Session session = Session.getInstance(props, new Authenticator() {
				...
				protected PasswordAuthentication getPasswordAuthentication() {
					return new PasswordAuthentication("seou7607@gmail.com", "nyhaxmqyjjnkvdgi"); // 보내는 사람 메일, 앱
																									// 비밀번호(https://yermi.tistory.com/346)
				}
			});
