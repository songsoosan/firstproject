...
public class BoardController {
	...
	public HashMap<String, Object> list(@RequestParam String page, @RequestParam String cnt,
			@RequestParam String searchText, @RequestParam String loginId) {
	...
	@ResponseBody
	public void commentUpdate(@RequestParam int board_id, @RequestParam int comment_id,
	...
	public String freedetail(Model model, @RequestParam String board_id) {
		logger.info("freedetail : " + board_id);
		String page = "redirect:/freeList";

		BoardDTO dto = service.freedetail(board_id, "detail");
		if (dto != null) {
			page = "freeDetail";
			model.addAttribute("dto", dto);
		}
		List<BoardDTO> replyList = service.freecommentList(board_id);
		if (replyList != null) {
			model.addAttribute("commentList", replyList);
		}
		return page;
	...
	public String freeUpdate(Model model, @RequestParam String board_id) {
		logger.info("detail : " + board_id);
		String page = "redirect:/freeList";

		BoardDTO dto = service.freedetail(board_id, "update");
		if (dto != null) {
			page = "freeUpdate";
			model.addAttribute("dto", dto);
		}
	...
	public String freeDelete(Model model, @RequestParam String board_id) {
		logger.info("detail : " + board_id);
		String page = "redirect:/freeList.do";

		service.freedelete(board_id);
