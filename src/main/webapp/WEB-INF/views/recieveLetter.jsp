		...
		<div class="contentBox">
			...
			<div class="row mb-3">
				<div class="col-sm-6 d-flex">
					<button class="none adminArea btn btn-outline-primary float-start"
						onclick="location.href='recieveletter.go'">받은 쪽지함</button>
					<button
						class="none adminArea btn btn-outline-primary float-start mx-1"
						onclick="location.href='sendletter.go'">보낸 쪽지함</button>
					<span class="mt-1">게시물 갯수&nbsp;:&nbsp;</span> <select
						id="pagePerNum" class="form-select w-auto">
				...
				<div class="col-sm-6">
					<button
						class="none adminArea btn btn-outline-primary float-end mx-1"
						onclick="location.href='letterWrite.go'">글쓰기</button>
				</div>
			</div>
	...
	function listDraw(list) {
		...
		list
				.forEach(function(item, index) {
					...
					content += '<td><a href="detail.go?id=' + item.letter_id
							+ '">' + item.letter_tItle + '</a></td>';
