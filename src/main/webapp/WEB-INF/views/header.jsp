...
<body class="body">
   <header class="header container-fluid border-bottom py-3 justify-content-center d-flex">
      <div class="col-sm-1 offset-sm-3 text-center">
         <a href="main.go">
            <img src="resources/img/logo.png" alt="푸른식탁" width="90px" height="90px"/>
         </a>
      </div>
      <div class="col-sm-3">
      ...
      <div class="col-sm-2 offset-sm-1 mt-5 text-left">
         ...
         <c:if test="${sessionScope.loginId ne null}">
            <button class="btn btn-outline-success" onclick="location.href='logout.do'">로그아웃</button>
