   ...
   <div class="contentBox">
      ...
      <div class="fr" style="display:inline-flex;">
         <button type="button" class="btn btn-outline-secondary" onclick="location.href='freeList.do'">리스트</button>
           ...
           <button type="button" class="btn btn-outline-danger" onclick="location.href='./reportWrite.go?board_id=${dto.board_id}&board_title=${dto.board_title}&cat_id=${dto.cat_id}&user_id=${dto.user_id}&reporter=${sessionScope.loginId}'" >신고</button>
      </div>
         ...
         <tr class="reply">
            ...
            <td class="col-sm-2">
               ...
               <c:if test="${commentList.user_id ne loginId}">
                  <button type="button" class="btn btn-outline-danger" onclick="location.href='./reportWrite.go?board_id=${commentList.comment_id}&board_title=${commentList.comment_content}&cat_id=${commentList.cat_id}&user_id=${commentList.user_id}&reporter=${sessionScope.loginId}'">신고</button>
               </c:if>                    
               </td>
            </tr>
      </c:forEach>
