	...
	<div class="container">
		<table class="table">
			...
			<tr>
				<th>처리 내용</th>
				<td>
					<input type="radio" name="status" id="경고" value="경고">
					<label for="경고">경고</label>
					<input type="radio" name="status" id="경고취소" value="경고취소">
					<label for="경고취소">경고취소</label>
					<input type="radio" name="status" id="탈퇴" value="탈퇴">
					<label for="탈퇴">탈퇴</label>
				</td>
			</tr>
			<tr>
				<th colspan="2">
