...
<body>
      ...
      <!-- 문의글 댓글 리스트 가져오기-->
      <c:if test="${magacommentlist.size() eq 0}">
      ...
      <c:forEach items="${magacommentlist}" var="comment">
         <div class="comment">
            ...
            <input type ="button" onclick='location.href="commentdel.do?comment_id=${comment.comment_id}&board_id=${board.board_id}"' value="삭제"/>
            <input type ="button" onclick='location.href="commentupdate.go?comment_id=${comment.comment_id}&board_id=${board.board_id}"' value="수정"/>
